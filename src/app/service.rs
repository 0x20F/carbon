    ...
    SubCommand::with_name("service")
        ...
        .subcommand(SubCommand::with_name("start")
            ...
            .arg(Arg::with_name("services")
                .help("Services to start ('all' for everything)")
                .required(true)
                .multiple(true)
                .index(1))
            ...
            .arg(Arg::with_name("dependencies")
                .short("a")
                .long("auto-dependencies")
                .help("Automatically start services that are dependencies of provided services"))
        )
        .subcommand(SubCommand::with_name("stop")
            .alias("p")
            .about("Stop a service")
            .arg(Arg::with_name("services")
                .help("Services to stop ('all' for everything)")
                .required(true)
                .multiple(true)
                .index(1))
        )
